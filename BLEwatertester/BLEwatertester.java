/* 
 * BLEwatertester by Christopher Lee
 *
 * Version 1.0,  2015-04-05
 * 
 * BLEwatertester is based on Firmata is a generic protocol for
 * communicating with microcontrollers
 * from software on a host computer. It is intended to work with
 * any host computer software package.
 *
 * It has also been modified to not only test for Water Purity in
 * Parts-per-Million but also incorporates the "OneWire" Temperature
 * probes logic.
 *
